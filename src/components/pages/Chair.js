                ...
                <div className="center" >
                    <div className=" full_width  flex  mt-5 " >
                        <div className="aside">
                            <div className="all_categories  "  >
                                ...
                                <ul className=" category_list  flex direction_column" >
                                    ...
                                    <li>
                                        <div  className="flex justify-content-between "  >
                                            <a href="#" className="my_active"  >Chair Kimi</a>
                                            <button type="button" className="category_btn" ><i className="fas fa-angle-right"></i></button>
                                        </div>
                                        <div  className="sub_category" >
                                            <ul className="sub_category_big_list" >
                                ...
                                <div className="two_block" >
                                    ...
                                    <div className="first_block">
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers1.jpg" alt="bestsellers" />
                                                </a>
                                            </div>
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers2.jpg" alt="bestsellers" />
                                                </a>
                                            </div>
                                            <div className="child_right_side" >
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers3.jpg" alt="bestsellers" />
                                                </a>
                                            </div>
                                            <div className="child_right_side" >
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers4.jpg" alt="bestsellers" />
                                                </a>
                                            </div>
                                            <div className="child_right_side" >
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers5.jpg" alt="bestsellers" />
                                                </a>
                                            </div>
                                            <div className="child_right_side" >
                                    ...
                                    <div className="second_block">
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers6.jpg" alt="bestsellers" />
                                                </a>
                                            </div>
                                            <div className="child_right_side" >
                                                <a href="#">[Sample] Able Brewing System</a>
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers7.jpg" alt="bestsellers" />
                                                </a>
                                            </div>
                                            <div className="child_right_side" >
                                                <a href="#">[Sample] Tiered Wire Basket</a>
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers8.jpg" alt="bestsellers" />
                                                </a>
                                            </div>
                                            <div className="child_right_side" >
                                                <a href="#">[Sample] Canvas Laundr Cart </a>
                        ...
                        <div className="main_product_container" >
                            ...
                            <div className="main_product_container_child_2 full_width "  >
                                <h3>SUB CATEGORIES</h3>
                                <div className="coming_soon_container flex " >
                                    <div className="coming_soon_container_child" >
                                        <img src="assets/images/dropmenu2.jpg" alt=""/>
                                        <a href="#"><h3>Muffler Type</h3></a>
                                    </div>
                                    <div className="coming_soon_container_child"  >
                                        <img src="assets/images/dropmenu3.jpg" alt=""/>
                                        <a href="#"><h3>Pareo Sarong <br/> Scarves</h3></a>
                                    </div>
                                    <div  className="coming_soon_container_child"  >
                                        <img src="assets/images/dropmenu4.jpg" alt=""/>
                                        <a href="#"><h3>Pasmina <br/> Scarves</h3></a>
                                    </div>
                                    <div  className="coming_soon_container_child"  >
                                        <img src="assets/images/dropmenu5.jpg" alt=""/>
                                        <a href="#"><h3>Silk  Scarves</h3></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="main_product_container_child_3 flex    full_width " >
                            
                            {
                                ...
                                <div className="little_product flex direction_column">
                                    ...
                                    <a href="#" className="little_img_link">
                                        <img src="assets/images/best_product_img3.jpg" alt="" className="little_img" />

                                        <div className="little_hover_img">
                                        <img src="assets/images/best_product_hoverimg3.jpg" alt="" />
                                        </div>
                                    </a>
                                    ...
                                    <div>[Sample] Fog Linen Chambray...</div>
                                    <div>
                                        <span><i className="fas fa-star"></i></span>
                                        <span><i className="fas fa-star"></i></span>
                                        <span><i className="fas fa-star"></i></span>
