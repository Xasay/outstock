...
export default function Shop() {
    ...
    useLayoutEffect(() => {
      getPostsByType(10,100).then(res=>{
                                ...
                                <ul className=" category_list  flex direction_column" >
                                    <li>
                                       <div className="flex justify-content-between " >
                                            <a  href="#" className="my_active" >Shop All</a>
                                ...
                                <div className="two_block" >
                                    ...
                                    <div className="first_block">
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers1.jpg"  />
                                                </a>
                                            </div>
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers2.jpg"  />
                                                </a>
                                            </div>
                                            <div className="child_right_side" >
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers3.jpg"  />
                                                </a>
                                            </div>
                                            <div className="child_right_side" >
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers4.jpg"  />
                                                </a>
                                            </div>
                                            <div className="child_right_side" >
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers5.jpg"  />
                                                </a>
                                            </div>
                                            <div className="child_right_side" >
                                    ...
                                    <div className="second_block">
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers6.jpg"  />
                                                </a>
                                            </div>
                                            <div className="child_right_side" >
                                                <a href="#">[Sample] Able Brewing System</a>
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers7.jpg"  />
                                                </a>
                                            </div>
                                            <div className="child_right_side" >
                                                <a href="#">[Sample] Tiered Wire Basket</a>
                                        ...
                                        <div className="first_block_child  flex " >
                                            <div className="child_left_side" >
                                                <a href="#">
                                                    <img src="assets/images/best_sellers8.jpg"  />
                                                </a>
                                            </div>
                                            <div className="child_right_side" >
                                                <a href="#">[Sample] Canvas Laundr Cart </a>
                            ...
                            <div className="custom_cms_block" >
                                ...
                                <div className="cms_container" >
                                    <div className="cms_img_container" >
                                        <img src="assets/images/cmsblock.jpg"  className="w-100 h-100" />
                                    </div>
                                ...
                                <div className="cms_bottom" >
                                    <img src="assets/images/sidebar-banner.jpg"  />
                                </div>
                            </div>
                            ...
                            <div className="main_product_container_child_2 full_width "  >
                                ...
                                <div className="coming_soon_container flex " >
                                    <div className="coming_soon_container_child" >
                                        ...
                                        <a href="#"><h3>Acapulca Chair</h3></a>
                                    </div>
                                    <div className="coming_soon_container_child"  >
                                        <img src="assets/images/coming_soon.jpg"  />
                                        <a href="#"><h3>Adirondack Chair</h3></a>
                                    </div>
                                    <div  className="coming_soon_container_child"  >
                                        <img src="assets/images/coming_soon.jpg"  />
                                        <a href="#"><h3>Balans Chair</h3></a>
                                    </div>
                                </div>
                            </div>
