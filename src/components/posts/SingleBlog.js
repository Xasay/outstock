...
import { getPostsByType,getPostBySlug } from '../../utilts/Models';
                    ...
                    <div  className="left" >
                                 ...
                                 <div className="posts" >
                                        <div className="post_image" >
                                            <img src={single.featured} alt="" className="w-100 h-100" />
                                        </div>
                                        <div className="post_card flex flex-column " >
                                            <a href="#" className="post_heading" > {single.title} </a>
                                            <div className="date" >Posted by <span>{single.author}</span> /{single.date} </div>
                                            <p className="post_text" >{single.content}</p>
                                            <a href="#" className="post_button" >READ MORE </a>
                                        </div>
                                     </div>
                            ...
                            <div className="two_block" > 
                                <div className="first_block">
                                            ...
                                            return(
                                                ...
                                                <div className="first_block_child  flex " >
                                                    <div className="child_left_side" >
                                                        <a href={item.link}>
                                                            <img src={item.metas.gallery[0]} alt="" className="w-100 h-100 " />
                                                        </a>
                                                    </div>
                                   ...
                                   {/*  <div className="first_block_child  flex " >
                                        <div className="child_left_side" >
                                            <a href="#">
                                                <img src="assets/images/blog-recent2.jpg" alt=""/>
                                            </a>
                                        </div>
                                        <div className="child_right_side" >
                                            <a href="#">At vero eos et accusam et justo</a>
                                            <div className="mb-1" >
                                    ...
                                    <div className="first_block_child  flex " >
                                        <div className="child_left_side" >
                                            <a href="#">
                                                <img src="assets/images/blog-recent3.jpg" alt=""/>
                                            </a>
                                        </div>
                                        <div className="child_right_side" >
                                    ...
                                    <div className="first_block_child  flex " >
                                        <div className="child_left_side" >
                                            <a href="#">
                                                <img src="assets/images/blog-recent1.jpg" alt=""/>
                                            </a>
                                        </div>
                                        <div className="child_right_side" >
                                            <a href="#">Tempor invidunt ut labore et dolore magna </a>
                                            <div className="mb-1" >
                                                <span className="date" >11 apr 2019</span>
                                            </div>
